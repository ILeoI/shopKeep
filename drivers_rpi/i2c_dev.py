...
# old and new versions of the RPiGPIO have swapped the two i2c buses
...
class CustomCharacters:
    ...
    # characters is hold in file custom_characters.txt in the same folder as lcd.py
